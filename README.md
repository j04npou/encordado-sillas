...
- Mover la previsualización de la imagen importada antes de fijarla en el patrón.
...
- Exportar el diseño actual como imagen PNG.
...
6. Pulsa **Exportar diseño PNG** para descargar el patrón.
